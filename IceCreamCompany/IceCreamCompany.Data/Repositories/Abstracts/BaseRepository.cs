...
namespace IceCreamCompany.Data.Repositories.Abstracts
{
    public abstract class BaseRepository : IRepository { }
    public abstract class BaseRepository<T> : BaseRepository, IRepository<T>
        where T : class, IEntity
    {
        protected readonly IceCreamCompanyContext _context;

        public BaseRepository(IceCreamCompanyContext _context)
        {
